    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 150, 1, 1, new DateTime(2023, 9, 5, 12, 52, 3, 735, DateTimeKind.Local).AddTicks(6722) },
                    { 2, 100, 2, 2, new DateTime(2023, 9, 5, 12, 52, 3, 735, DateTimeKind.Local).AddTicks(6791) },
                    { 3, 200, 3, 3, new DateTime(2023, 9, 5, 12, 52, 3, 735, DateTimeKind.Local).AddTicks(6793) },
                    { 4, 150, 1, 4, new DateTime(2023, 9, 5, 12, 52, 3, 735, DateTimeKind.Local).AddTicks(6796) },
                    { 5, 100, 2, 5, new DateTime(2023, 9, 5, 12, 52, 3, 735, DateTimeKind.Local).AddTicks(6798) },
                    { 6, 200, 3, 6, new DateTime(2023, 9, 5, 12, 52, 3, 735, DateTimeKind.Local).AddTicks(6800) }
                });
