...
namespace TicketApplication.Data.Data
{
    public class ApplicationDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new Movie { Id = 3, Name = "Barbie", Description = "Barbie and Ken are having the time of their lives in the colorful and seemingly perfect world of Barbie Land. However, when they get a chance to go to the real world, they soon discover the joys and perils of living among humans.", Duration = 120, ReleaseYear = 2023, TicketPrice = 10, CategoryId = 3, ImageUrl = "/app/seed_images/barbie.jpg" },
            new Movie { Id = 4, Name = "John Wick: Chapter 4", Description = "With the price on his head ever increasing, legendary hit man John Wick takes his fight against the High Table global as he seeks out the most powerful players in the underworld, from New York to Paris to Japan to Berlin.", Duration = 120, ReleaseYear = 2023, TicketPrice = 12, CategoryId = 1, ImageUrl = "/app/seed_images/john_wick.jpg" },
